 ...
 *
 */
public class CustomerShedLoadSemaphoreValve extends ValveBase {
     ...
     * @param shedLoad
     */
    public CustomerShedLoadSemaphoreValve(ShedLoadSemaphore shedLoad) {
        super(true);
    ...
    public void invoke(Request request, Response response) throws IOException, ServletException {
        ...
        } catch (ShedLoadSemaphore.LoadExceedException e) {
