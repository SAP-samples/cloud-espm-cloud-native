...
* [DISCOVER](../documentation/discover/README.md)
    ...
    2. [The Mission Story](./discover/mission-story/README.md)
    3. [Learn the Basics of SAP BTP](./discover/sap-btp-basics/README.md)
    4. [Learn about SAP Event Mesh](./discover/sap-event-mesh/README.md)
    5. [Discover the Basics of SAP HANA Cloud](./discover/hana-cloud/README.md)
    6. [Discover the Basics of SAP Authorization and Trust Management Service](./discover/xsuaa/README.md)
    7. [Discover SAPUI5](./discover/ui5/README.md) 
...
* [DEVELOP](./documentation/develop/README.md)
    ...
    4. [Resilience Patterns in Action - Timeout](./execute/timeout/README.md)
